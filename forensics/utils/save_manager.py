...
def _default_save(player_name: str) -> dict:
    ...
    Schema:
        ...
        badges, completed, skipped, hints_used,
        notes, metrics
...
def list_saves() -> list:
    """Return list of dicts [{name, last_played, xp, completed_count}] sorted by last_played desc."""
    saves = _saves_dir()
